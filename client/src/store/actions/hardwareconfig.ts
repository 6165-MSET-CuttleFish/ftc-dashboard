import { RECEIVE_HARDWARE_CONFIG_LIST, SET_HARDWARE_CONFIG, WRITE_HARDWARE_CONFIG, DELETE_HARDWARE_CONFIG, DeleteHardwareConfigAction, SetHardwareConfigAction, WriteHardwareConfigAction, ReceiveHardwareConfigListAction } from "../types/hardwareconfig";
...
export const deleteHardwareConfig = (hardwareConfigName: string): DeleteHardwareConfigAction => ({
