...
/*
 * Test the dashboard keyboard emulator integration.
 */
@Autonomous
public class KeyboardEmulatorTestOpMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        dashboard.enableKeyboardEmulator();
        ReceiveKeyboardState.KeyboardState testKeyboard = new ReceiveKeyboardState.KeyboardState();
        testKeyboard.setTestingState();
        dashboard.updateGamepadsFromKeyboard(testKeyboard);
